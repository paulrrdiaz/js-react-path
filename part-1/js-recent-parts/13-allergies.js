...
(i.e. allergens that score 256, 512, 1024, etc.). Your program should ignore those 
components of the score. For example, if the allergy score is 257, your program 
...
class Allergies {
  constructor(score = 0) {
    this.score = Array.from(score.toString(2)).reverse();
  }

  list() {
    return ALLERGIES.filter((allergy, index) => Number(this.score[index]));
  }
