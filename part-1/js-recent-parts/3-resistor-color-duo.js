...
you'll probably use resistors. For this exercise, 
...
Each band has a position and a numeric value. For example, 
if they printed a brown band (value 1) followed by a green band 
...
const decodedValue = ([firstColor, secondColor]) =>
  Number(`${COLORS.indexOf(firstColor)}${COLORS.indexOf(secondColor)}`);
